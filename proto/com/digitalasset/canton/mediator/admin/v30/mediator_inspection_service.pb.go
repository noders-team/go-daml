...
type VerdictsResponse_Complete_ struct {
	Complete *VerdictsResponse_Complete `protobuf:"bytes,2,opt,name=complete,proto3,oneof"` // No further verdicts will be sent after this message.
}
...
const file_com_digitalasset_canton_mediator_admin_v30_mediator_inspection_service_proto_rawDesc = "" +
	...
	"\bVerdicts\x12;.com.digitalasset.canton.mediator.admin.v30.VerdictsRequest\x1a<.com.digitalasset.canton.mediator.admin.v30.VerdictsResponse0\x01BQZOgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/mediator/admin/v30b\x06proto3"
