...
type Commit struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	BlockHash      []byte                 `protobuf:"bytes,1,opt,name=block_hash,json=blockHash,proto3" json:"block_hash,omitempty"`
	LocalTimestamp int64                  `protobuf:"varint,2,opt,name=local_timestamp,json=localTimestamp,proto3" json:"local_timestamp,omitempty"` // creation time, in microseconds of UTC time since Unix epoch
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_com_digitalasset_canton_synchronizer_sequencing_sequencer_bftordering_v30_bft_ordering_service_proto_rawDesc = "" +
	...
	"\aReceive\x12].com.digitalasset.canton.synchronizer.sequencing.sequencer.bftordering.v30.BftOrderingMessage\x1a].com.digitalasset.canton.synchronizer.sequencing.sequencer.bftordering.v30.BftOrderingMessage(\x010\x01BpZngithub.com/noders-team/go-daml/proto/com/digitalasset/canton/synchronizer/sequencing/sequencer/bftordering/v30b\x06proto3"
