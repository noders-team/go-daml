...
import (
	...
	v30 "github.com/noders-team/go-daml/proto/com/digitalasset/canton/v30"
...
type PossiblyIgnoredSequencedEvent struct {
	...
	Timestamp     int64                  `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // in microseconds of UTC time since Unix epoch
	...
	Underlying    []byte                 `protobuf:"bytes,5,opt,name=underlying,proto3,oneof" json:"underlying,omitempty"` // Serialized SignedContent[SequencedEvent]. Optional if is_ignored == true, required otherwise
...
type ServiceAgreement struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // A unique identifier of an agreement within a synchronizer, which must change when the legal text changes
...
const file_com_digitalasset_canton_protocol_v30_sequencing_proto_rawDesc = "" +
	...
	"\x13_topology_timestampBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
