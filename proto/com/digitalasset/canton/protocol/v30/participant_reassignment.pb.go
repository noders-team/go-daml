...
type AssignmentCommonData struct {
	...
	Stakeholders                 *Stakeholders                  `protobuf:"bytes,3,opt,name=stakeholders,proto3" json:"stakeholders,omitempty"` // stakeholders of the contract
	Uuid                         string                         `protobuf:"bytes,4,opt,name=uuid,proto3" json:"uuid,omitempty"`                 // request uuid
...
type ReassignmentSubmitterMetadata struct {
	...
	SubmissionId             string                 `protobuf:"bytes,4,opt,name=submission_id,json=submissionId,proto3" json:"submission_id,omitempty"` // optional
...
const file_com_digitalasset_canton_protocol_v30_participant_reassignment_proto_rawDesc = "" +
	...
	"\x14reassignment_counter\x18\x02 \x01(\x03R\x13reassignmentCounterBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
