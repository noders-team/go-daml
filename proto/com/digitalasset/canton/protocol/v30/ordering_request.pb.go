...
type OrderingRequest struct {
	...
	SequencerUid  string                 `protobuf:"bytes,1,opt,name=sequencer_uid,json=sequencerUid,proto3" json:"sequencer_uid,omitempty"` // UID of the sequencer requesting ordering of the request
	Content       []byte                 `protobuf:"bytes,2,opt,name=content,proto3,oneof" json:"content,omitempty"`                         // Content of the request to be ordered
...
const file_com_digitalasset_canton_protocol_v30_ordering_request_proto_rawDesc = "" +
	...
	"\n" +
	"\b_contentBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
