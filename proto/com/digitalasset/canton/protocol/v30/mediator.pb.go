...
type MediatorReject struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Reason        *status.Status         `protobuf:"bytes,1,opt,name=reason,proto3" json:"reason,omitempty"`                               // Must not be OK
	IsMalformed   bool                   `protobuf:"varint,2,opt,name=is_malformed,json=isMalformed,proto3" json:"is_malformed,omitempty"` // True if the request has been recognized as malformed.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_com_digitalasset_canton_protocol_v30_mediator_proto_rawDesc = "" +
	...
	"\averdict\x18\x05 \x01(\v2-.com.digitalasset.canton.protocol.v30.VerdictR\averdictBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
