...
type TrafficControlParameters struct {
	...
	// Default: false
	FreeConfirmationResponses bool `protobuf:"varint,8,opt,name=free_confirmation_responses,json=freeConfirmationResponses,proto3" json:"free_confirmation_responses,omitempty"` // [doc-entry-end: TrafficControlParameters]
...
type TrafficConsumed struct {
	...
	SequencingTimestamp int64 `protobuf:"varint,5,opt,name=sequencing_timestamp,json=sequencingTimestamp,proto3" json:"sequencing_timestamp,omitempty"` // in microseconds of UTC time since Unix epoch
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type TrafficPurchased struct {
	...
	SequencingTimestamp int64 `protobuf:"varint,4,opt,name=sequencing_timestamp,json=sequencingTimestamp,proto3" json:"sequencing_timestamp,omitempty"` // // in microseconds of UTC time since Unix epoch
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_com_digitalasset_canton_protocol_v30_traffic_control_parameters_proto_rawDesc = "" +
	...
	"\x18physical_synchronizer_id\x18\x05 \x01(\tR\x16physicalSynchronizerIdBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
