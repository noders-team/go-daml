...
type DeduplicationPeriod_Offset struct {
	Offset int64 `protobuf:"varint,2,opt,name=offset,proto3,oneof"` // if specified, it must be a valid absolute offset (positive integer) or zero (ledger begin offset)
}
...
type ParticipantMetadata struct {
	...
	LedgerTime      int64                  `protobuf:"varint,2,opt,name=ledger_time,json=ledgerTime,proto3" json:"ledger_time,omitempty"`                // in microseconds of UTC time since Unix epoch
	PreparationTime int64                  `protobuf:"varint,3,opt,name=preparation_time,json=preparationTime,proto3" json:"preparation_time,omitempty"` // in microseconds of UTC time since Unix epoch
...
type RootHashMessage struct {
	...
	SubmissionTopologyTime int64                  `protobuf:"varint,4,opt,name=submission_topology_time,json=submissionTopologyTime,proto3" json:"submission_topology_time,omitempty"` // in microseconds of UTC time since Unix epoch
	Payload                []byte                 `protobuf:"bytes,5,opt,name=payload,proto3" json:"payload,omitempty"`                                                                // optional
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type CreatedContract struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Contract       []byte                 `protobuf:"bytes,1,opt,name=contract,proto3" json:"contract,omitempty"` // Encoded ContractInstance
...
type SubmitterMetadata struct {
	...
	MaxSequencingTime        int64                  `protobuf:"varint,8,opt,name=max_sequencing_time,json=maxSequencingTime,proto3" json:"max_sequencing_time,omitempty"`          // in microseconds of UTC time since Unix epoch
	ExternalAuthorization    *ExternalAuthorization `protobuf:"bytes,9,opt,name=external_authorization,json=externalAuthorization,proto3" json:"external_authorization,omitempty"` // optional
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type EncryptedViewMessage struct {
	...
	SubmittingParticipantSignature *v30.Signature             `protobuf:"bytes,3,opt,name=submitting_participant_signature,json=submittingParticipantSignature,proto3" json:"submitting_participant_signature,omitempty"` // optional
...
type ExternalPartyAuthorization struct {
	...
	Signatures    []*v30.Signature       `protobuf:"bytes,2,rep,name=signatures,proto3" json:"signatures,omitempty"` // Signatures
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_com_digitalasset_canton_protocol_v30_participant_transaction_proto_rawDesc = "" +
	...
	"\x19HASHING_SCHEME_VERSION_V2\x10\x02\"\x04\b\x01\x10\x01BKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
