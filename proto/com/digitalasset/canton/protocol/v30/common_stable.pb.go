...
type SerializableContract struct {
	...
	LedgerCreateTime    int64                          `protobuf:"varint,4,opt,name=ledger_create_time,json=ledgerCreateTime,proto3" json:"ledger_create_time,omitempty"` // in microseconds of UTC time since Unix epoch
...
type Stakeholders struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	All           []string               `protobuf:"bytes,1,rep,name=all,proto3" json:"all,omitempty"`                 // all stakeholders of the contract
	Signatories   []string               `protobuf:"bytes,2,rep,name=signatories,proto3" json:"signatories,omitempty"` // signatories of the contract
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_com_digitalasset_canton_protocol_v30_common_stable_proto_rawDesc = "" +
	...
	"\vsignatories\x18\x02 \x03(\tR\vsignatoriesBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
