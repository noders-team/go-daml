...
type LocalVerdict struct {
	...
	Reason        *status.Status           `protobuf:"bytes,2,opt,name=reason,proto3" json:"reason,omitempty"` // ok iff code is approve
...
type ConfirmationResponse struct {
	...
	ConfirmingParties []string               `protobuf:"bytes,2,rep,name=confirming_parties,json=confirmingParties,proto3" json:"confirming_parties,omitempty"` // Empty iff the verdict is malformed.
...
type ConfirmationResponses struct {
	state                  protoimpl.MessageState  `protogen:"open.v1"`
	RequestId              int64                   `protobuf:"varint,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // in microseconds of UTC time since Unix epoch
	RootHash               []byte                  `protobuf:"bytes,2,opt,name=root_hash,json=rootHash,proto3" json:"root_hash,omitempty"`     // required since DAML 3.0
...
const file_com_digitalasset_canton_protocol_v30_confirmation_response_proto_rawDesc = "" +
	...
	"\bis_right\x18\x01 \x03(\bR\aisRightBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
