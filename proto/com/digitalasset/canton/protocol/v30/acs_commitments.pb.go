...
type AcsCommitment struct {
	...
	FromExclusive          int64                  `protobuf:"varint,4,opt,name=from_exclusive,json=fromExclusive,proto3" json:"from_exclusive,omitempty"` // in microseconds of UTC time since Unix epoch
	ToInclusive            int64                  `protobuf:"varint,5,opt,name=to_inclusive,json=toInclusive,proto3" json:"to_inclusive,omitempty"`       // in microseconds of UTC time since Unix epoch
...
const file_com_digitalasset_canton_protocol_v30_acs_commitments_proto_rawDesc = "" +
	...
	"signaturesBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30b\x06proto3"
