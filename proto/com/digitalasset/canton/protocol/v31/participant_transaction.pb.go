...
import (
	...
	v301 "github.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30"
...
type ViewParticipantData struct {
	...
	RollbackContext                *v301.ViewParticipantData_RollbackContext           `protobuf:"bytes,7,opt,name=rollback_context,json=rollbackContext,proto3" json:"rollback_context,omitempty"` // optional; defaults to the empty RollbackContext if omitted.
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
type EncryptedMultipleViewsMessage struct {
	...
	SubmittingParticipantSignature *v30.Signature             `protobuf:"bytes,4,opt,name=submitting_participant_signature,json=submittingParticipantSignature,proto3" json:"submitting_participant_signature,omitempty"` // optional
...
const file_com_digitalasset_canton_protocol_v31_participant_transaction_proto_rawDesc = "" +
	...
	"\n" +
	"view_trees\x18\x01 \x03(\fR\tviewTreesBKZIgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v31b\x06proto3"
