...
import (
	v301 "github.com/noders-team/go-daml/proto/com/digitalasset/canton/crypto/v30"
	v30 "github.com/noders-team/go-daml/proto/com/digitalasset/canton/protocol/v30"
...
type SequencerSnapshot struct {
	...
	LatestTimestamp          int64                                          `protobuf:"varint,1,opt,name=latest_timestamp,json=latestTimestamp,proto3" json:"latest_timestamp,omitempty"` // in microseconds of UTC time since Unix epoch
...
type SequencerMemberStatus struct {
	...
	RegisteredAt     int64                  `protobuf:"varint,2,opt,name=registered_at,json=registeredAt,proto3" json:"registered_at,omitempty"`                   // in microseconds of UTC time since Unix epoch
	LastAcknowledged *int64                 `protobuf:"varint,3,opt,name=last_acknowledged,json=lastAcknowledged,proto3,oneof" json:"last_acknowledged,omitempty"` // in microseconds of UTC time since Unix epoch
...
type SequencerSnapshot_InFlightAggregationWithId struct {
	...
	MaxSequencingTime int64                                    `protobuf:"varint,3,opt,name=max_sequencing_time,json=maxSequencingTime,proto3" json:"max_sequencing_time,omitempty"` // in microseconds of UTC time since Unix epoch
...
type SequencerSnapshot_AggregationBySender struct {
	...
	SequencingTimestamp  int64                                      `protobuf:"varint,2,opt,name=sequencing_timestamp,json=sequencingTimestamp,proto3" json:"sequencing_timestamp,omitempty"` // in microseconds of UTC time since Unix epoch
...
const file_com_digitalasset_canton_sequencer_admin_v30_sequencer_initialization_snapshot_proto_rawDesc = "" +
	...
	"\x04info\x18\x02 \x01(\fR\x04infoBRZPgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/sequencer/admin/v30b\x06proto3"
