...
import (
	...
	v301 "github.com/noders-team/go-daml/proto/com/digitalasset/canton/topology/admin/v30"
...
type SetTrafficPurchasedRequest struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	Member                string                 `protobuf:"bytes,1,opt,name=member,proto3" json:"member,omitempty"`                                                               // Member to top up
	Serial                uint32                 `protobuf:"varint,2,opt,name=serial,proto3" json:"serial,omitempty"`                                                              // Serial number of the request, will be used for idempotency
	TotalTrafficPurchased int64                  `protobuf:"varint,3,opt,name=total_traffic_purchased,json=totalTrafficPurchased,proto3" json:"total_traffic_purchased,omitempty"` // Amount of traffic to purchase
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
const file_com_digitalasset_canton_sequencer_admin_v30_sequencer_administration_service_proto_rawDesc = "" +
	...
	"\x18PerformLsuSequencingTest\x12L.com.digitalasset.canton.sequencer.admin.v30.PerformLsuSequencingTestRequest\x1aM.com.digitalasset.canton.sequencer.admin.v30.PerformLsuSequencingTestResponseBRZPgithub.com/noders-team/go-daml/proto/com/digitalasset/canton/sequencer/admin/v30b\x06proto3"
