...
type ThinContractInstance struct {
	...
	ArgVersioned *VersionedValue        `protobuf:"bytes,2,opt,name=arg_versioned,json=argVersioned,proto3" json:"arg_versioned,omitempty"`
...
func (x *ThinContractInstance) GetTemplateId() *Identifier {
	if x != nil {
		return x.TemplateId
	}
	return nil
...
func (x *ThinContractInstance) GetArgVersioned() *VersionedValue {
	if x != nil {
...
type FatContractInstance struct {
	...
	PackageVersion           []int32                `protobuf:"varint,9,rep,packed,name=package_version,json=packageVersion,proto3" json:"package_version,omitempty"` // required *since dev*
	...
	ContractKeyWithMaintainers *KeyWithMaintainers `protobuf:"bytes,1001,opt,name=contract_key_with_maintainers,json=contractKeyWithMaintainers,proto3" json:"contract_key_with_maintainers,omitempty"` // optional *since dev*
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *FatContractInstance) GetTemplateId() *Identifier {
	if x != nil {
		return x.TemplateId
	}
	return nil
...
type KeyWithMaintainers struct {
	...
	Maintainers   []string               `protobuf:"bytes,2,rep,name=maintainers,proto3" json:"maintainers,omitempty"` // the maintainers induced by the key
	Hash          []byte                 `protobuf:"bytes,3,opt,name=hash,proto3" json:"hash,omitempty"`               // the hash of the key *since serialization version 2*
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Node_Fetch struct {
	...
	ContractId               []byte                 `protobuf:"bytes,1,opt,name=contract_id,json=contractId,proto3" json:"contract_id,omitempty"`
	PackageName              string                 `protobuf:"bytes,2,opt,name=package_name,json=packageName,proto3" json:"package_name,omitempty"`
	TemplateId               *Identifier            `protobuf:"bytes,3,opt,name=template_id,json=templateId,proto3" json:"template_id,omitempty"`    // required
	InterfaceId              *Identifier            `protobuf:"bytes,7,opt,name=interface_id,json=interfaceId,proto3" json:"interface_id,omitempty"` // optional
...
func (x *Node_Fetch) GetInterfaceId() *Identifier {
	if x != nil {
...
type Node_Exercise struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	Fetch       *Node_Fetch            `protobuf:"bytes,1,opt,name=fetch,proto3" json:"fetch,omitempty"`                                // required
	InterfaceId *Identifier            `protobuf:"bytes,2,opt,name=interface_id,json=interfaceId,proto3" json:"interface_id,omitempty"` // optional
	...
	Children    []string               `protobuf:"bytes,6,rep,name=children,proto3" json:"children,omitempty"` // node ids
	...
	Authorizers   []string `protobuf:"bytes,1001,rep,name=authorizers,proto3" json:"authorizers,omitempty"` // *since version dev*
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Node_Rollback struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Children      []string               `protobuf:"bytes,1,rep,name=children,proto3" json:"children,omitempty"` // node ids
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Node_QueryByKey) GetTemplateId() *Identifier {
	if x != nil {
		return x.TemplateId
	}
	return nil
...
const file_com_digitalasset_daml_lf_transaction_proto_rawDesc = "" +
	...
	"\x04hash\x18\x03 \x01(\fR\x04hashBe\n" +
	"$com.digitalasset.daml.lf.transactionZ=github.com/noders-team/go-daml/proto/com/digitalasset/daml/lfb\x06proto3"
...
var file_com_digitalasset_daml_lf_transaction_proto_goTypes = []any{
	...
	(*Identifier)(nil),           // 10: com.digitalasset.daml.lf.value.Identifier
	(*VersionedValue)(nil),       // 11: com.digitalasset.daml.lf.value.VersionedValue
}
...
func file_com_digitalasset_daml_lf_transaction_proto_init() {
	...
	file_com_digitalasset_daml_lf_value_proto_init()
