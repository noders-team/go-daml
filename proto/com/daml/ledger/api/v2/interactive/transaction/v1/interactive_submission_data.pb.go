...
const file_com_daml_ledger_api_v2_interactive_transaction_v1_interactive_submission_data_proto_rawDesc = "" +
	...
	"queryByKeyB\v\n" +
	"\tnode_typeB\xe4\x01\n" +
	"1com.daml.ledger.api.v2.interactive.transaction.v1B#InteractiveSubmissionDataOuterClassZVgithub.com/noders-team/go-daml/proto/com/daml/ledger/api/v2/interactive/transaction/v1\xaa\x021Com.Daml.Ledger.Api.V2.Interactive.Transaction.V1b\x06proto3"
