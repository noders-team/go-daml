...
const file_com_daml_ledger_api_v2_state_service_proto_rawDesc = "" +
	...
	"\x16GetLatestPrunedOffsets\x125.com.daml.ledger.api.v2.GetLatestPrunedOffsetsRequest\x1a6.com.daml.ledger.api.v2.GetLatestPrunedOffsetsResponseB\x86\x01\n" +
	"\x16com.daml.ledger.api.v2B\x16StateServiceOuterClassZ;github.com/noders-team/go-daml/proto/com/daml/ledger/api/v2\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
